...
cp %{_builddir}/Crypt-GeneratePassword-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-Crypt-GeneratePassword/551e65f635caca1104133037d5f7acf642a411a7 || :
if test -f Makefile.PL; then
